<x-app-layout>
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 mb-12">
        <div class="grid-cols-12 grid gap-12">

            <div class="col-span-5">
                <img src="/{{ $game['cover'] }}" alt="" class="w-full object-cover rounded-lg">
                <h1 class="text-3xl font-semibold mt-4">{{ $game['name'] }}</h1>
                <p class="text-lg mt-4">{{ $game['desc'] }}</p>

                <div class="flex items-center mt-5">
                    <img src="/app_store_coda.png" alt="" class="w-32 h-8 object-scale-down">
                    <img src="/google_play_coda.png" alt="" class="w-32 h-8 object-scale-down">
                </div>
            </div>
            ...
            <div class="col-span-7">
                <ol class="relative border-s border-gray-200 dark:border-gray-700 dark:text-gray-400">
                    <li class="mb-10 ms-6">
                        ...
                        <h3 class="font-medium leading-tight">Masukkan PlayerID</h3>
                        <input type="text" oninput="userId(this.value)"
                            class="mt-4 w-full border border-gray-200 rounded-lg px-4 py-2 focus:outline-none focus:border-green-500 text-black"
                            placeholder="Masukkan PlayerID">
                    </li>
                    ...
                    <li class="mb-10 ms-6">
                        ...
                        <h3 class="font-medium leading-tight">Pilih Nominal Top Up</h3>
                        <div class="grid-cols-5 mt-4 grid gap-2">
                            @foreach ($game['nominal'] as $item => $nominal)
                                <div onclick="chooseItem('{{ $item . '|' . $nominal }}')"
                                    class="col-span-1 bg-white text-black rounded-2xl overflow-hidden">
                                    <div
                                        class="border h-full  justify-evenly border-gray-200 rounded-lg p-4 flex flex-col items-center hover:border-green-500 transition duration-300 cursor-pointer">
                                        <img src="/{{$game['logo']}}" class="w-8 h-8"/>
                                        <h1 class="text-xl text-center font-bold">{{ $item }}</h1>
                                        <p class="text-sm">
                    ...
                    <li class="ms-6" x-show="selectedNominal && selectedPayment">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="flex flex-col justify-between mt-2">
                                <div>
                                    User ID: <span id="user_id" class="font-bold" x-text="playerID"></span>
                                </div>
                                <div>
                        ...
                        <button onclick="sendData()" data-modal-target="default-modal"
    ...
    <script>
        ...
        function choosePaymentMethod(method) {
            ...
            user_id.innerHTML = JSON.parse(localStorage.getItem('user_id'));
        ...
        function sendData() {
            ...
            if (user_id == null || item == null || payment_method == null) {
